...
namespace 김주엽_과제_14_01_Client
{
    ...
    {
        Form2 subForm;
        enum SceneState { NONE = -1, NEWGAME };
        ...
        void Connect()
        {
            try
            {
                IPEndPoint ipep = new IPEndPoint(IPAddress.Parse(subForm.txtBox_IP.Text), Int32.Parse(subForm.txtBox_PortNum.Text));
